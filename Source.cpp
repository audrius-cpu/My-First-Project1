...
std::list<studentas> failo_nuskaitymas1(const string& filename)
{
...
list<studentas> failo_nuskaitymas2(const string& filename)
{
...
list<studentas> failo_nuskaitymas3(const string& filename)
{
    auto start = chrono::steady_clock::now();
    list<studentas> students;
    list<studentas> geri;
